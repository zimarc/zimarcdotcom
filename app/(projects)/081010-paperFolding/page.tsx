...
// Import local images
import image1 from './img/paperFolding-zimarc.svg';
import image2 from './img/paperFolding-zimarc-02.jpg';
import image3 from './img/paperFolding-zimarc-01.jpg';
...
function App() {
  ...
  return (
    <div className='max-w-screen-x1 mx-auto py-16 px-4 relative group'>
